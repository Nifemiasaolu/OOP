...
class EVCl extends CarCl {
  //Extends is used bcos EVCl is a child class of CarCl,
  ...
  chargeBattery(chargeTo) {
    // using methods to the Class. This method is a public API, so as to be able to manipulate it.
    this.#charge = chargeTo;
    return this; // 'Returning this' is used when trying the chain up methods.
  }

  accelerate() {
    // using methods to the Class
    this.speed += 20;
    this.#charge--;
    console.log(
      `${this.make} is going at ${this.speed} km/h, wuth a charge of ${
        this.#charge
      }`
    );
    return this;
